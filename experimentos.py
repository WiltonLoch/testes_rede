...
def experimento():
    ...
    for i in range(len(casos_teste)):
       ...
       Testes.emitir_sl_paralelos(rede, casos_teste[i].split(), caminho, portas_escolhidas, portas_em_uso, BatchProcessing.ljf, Politicas.menorPuloLivre, alocacoes, matrizPulos)
